...
if( 0 < global::color.get_hue() && global::color.get_hue() < 70) {
  ...
  chassis.pid_wait();
  chassis.pid_turn_relative_set(42_deg, 60, false);
  chassis.pid_wait();
  chassis.pid_drive_set(16_in, 25, false);
  chassis.pid_wait();
  pros::delay(500);
...
if( 0 < global::color.get_hue() && global::color.get_hue() < 70) {
  ...
  // chassis.pid_wait();
  // chassis.pid_turn_relative_set(16_deg, 30, false);
  // chassis.pid_wait();
  // chassis.pid_drive_set(30_in, 30, false);
  // chassis.pid_wait();
  // pros::delay(100);
  // chassis.pid_turn_relative_set(90_deg, 50, false);
  // chassis.pid_wait();
  // pros::delay(100);
